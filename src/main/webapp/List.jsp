        ...
        <div class="bodysearch">
            <div class="container mt-5">
                <div class="search-box">
                    ...
                    <!-- Form fields -->
                    <form class="row g-3 form-section" action="home" method="get">
                        <div class="col-md-6">
                            <label class="form-label">Bạn muốn đi đâu <span
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Ngày khởi hành từ</label>
                            <input type="date" class="form-control" min="2000-01-01"
                                   max="2025-12-31" name="start_date">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Ngày khởi hành đến</label>
                            <input type="date" class="form-control" min="2000-01-01"
                                   max="2025-12-31" name="end_date">
                        </div>
