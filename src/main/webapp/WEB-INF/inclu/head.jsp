                    ...
                    <div class="header-top">
                        <div class="container">
                            <div class="contact-info">
                                <a href="mailto:info@saigontourist.net"><i class="fa fa-envelope"
                                        aria-hidden="true"></i> info@saigontourist.net</a>
                                <a href="tel:19001808"><i class="fa fa-phone" aria-hidden="true"></i> Hotline: 1900
                                    1808</a>
                            </div>
                    ...
                    <div class="slider">
                        <div class="slide">
                            ...
                            <div class="slide-content">
                                <h2>Khám Phá Thế Giới Cùng GR5</h2>
                            </div>
                        </div>
                        <div class="slide">
